							...
							<div className="blog_left_sidebar">
								<article className="row blog_item">
									...
									<div className="col-md-9">
										<div className="blog_post">
											<img
												src="/images/blog/main-blog/m-blog-1.jpg"
												alt="blog1"
											/>
								...
								<article className="row blog_item">
									...
									<div className="col-md-9">
										<div className="blog_post">
											<img
												src="/images/blog/main-blog/m-blog-2.jpg"
												alt="blog2"
											/>
											<div className="blog_details">
												<a href="single-blog.html">
								...
								<article className="row blog_item">
									...
									<div className="col-md-9">
										<div className="blog_post">
											<img
												src="images/blog/main-blog/m-blog-3.jpg"
												alt="blog3"
											/>
											<div className="blog_details">
												<a href="single-blog.html">
								...
								<article className="row blog_item">
									...
									<div className="col-md-9">
										<div className="blog_post">
											<img
												src="/iamges/blog/main-blog/m-blog-4.jpg"
												alt="blog4"
											/>
											<div className="blog_details">
												<a href="single-blog.html">
								...
								<article className="row blog_item">
									...
									<div className="col-md-9">
										<div className="blog_post">
											<img
												src="images/blog/main-blog/m-blog-5.jpg"
												alt="blog5"
											/>
											<div className="blog_details">
												<a href="single-blog.html">
						...
						<div className="col-lg-4">
							<div className="blog_right_sidebar">
								...
								<aside className="single_sidebar_widget popular_post_widget">
									...
									<div className="media post_item">
										<img
											src="/images/blog/popular-post/post3.jpg"
											alt="post"
										/>
										<div className="media-body">
											<a href="blog-details.html">
									...
									<div className="media post_item">
										<img
											src="/images/blog/popular-post/post4.jpg"
											alt="post"
										/>
										<div className="media-body">
											<a href="blog-details.html">
