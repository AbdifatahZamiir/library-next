export default function Events() {
	return (
		<div className="events_area mb-5">
			<div className="container">
				...
				<div className="row">
					<div className="col-lg-6 col-md-6">
						<div className="single_event position-relative">
							<div className="event_thumb">
								<img src="/images/event/e1.jpg" alt="event1" />
							</div>
							<div className="event_details">
								...
								<p>
									One make creepeth man for so bearing their
									firmament won't fowl meat over seas great
								</p>
								<a
									href="#"
					...
					<div className="col-lg-6 col-md-6">
						<div className="single_event position-relative">
							<div className="event_thumb">
								<img src="images/event/e2.jpg" alt="event2" />
							</div>
							<div className="event_details">
								<div className="d-flex mb-4">
									<div className="date">
					...
					<div className="col-lg-12">
						<div className="text-center pt-lg-5 pt-3">
							<a href="#" className="event-link">
								View All Event{" "}
								<img src="/images/next.png" alt="nextPic" />
							</a>
						</div>
					</div>
				</div>
